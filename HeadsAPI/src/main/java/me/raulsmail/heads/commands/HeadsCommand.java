    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        if (sender instanceof Player) {
            ...
            if (player.hasPermission("me.raulsmail.headsapi.command")) {
                ...
                player.getInventory().addItem(HeadsAPI.createNameItemHead("raulsmail"), HeadsAPI.createBase64ItemHead("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNTE1ZGNiMmRhMDJjZjczNDgyOWUxZTI3M2UzMDI1NjE3ZDgwNzE1MTZmOTUzMjUxYjUyNTQ1ZGE4ZDNlOGRiOCJ9fX0=".getBytes()), HeadsAPI.createTextureURLItemHead("http://textures.minecraft.net/texture/b6287e255cba7e426b6a0389018ddd43e8133781ba419b426a62a07adb0cc"));
            } else {
